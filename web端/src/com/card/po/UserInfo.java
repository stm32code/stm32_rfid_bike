...
public class UserInfo {
    ...
    public JSONObject getJsonObject() throws JSONException {
		...
		jsonUserInfo.accumulate("schoolState", this.getSchoolState());
		jsonUserInfo.accumulate("roleName", this.getRoleName());
