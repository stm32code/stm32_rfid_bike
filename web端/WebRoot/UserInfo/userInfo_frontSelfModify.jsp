	...
	<ul class="breadcrumb">
		...
		<div class="row"> 
		  ...
		  <div class="form-group">
		  	 ...
		  	 <div class="col-md-9">
			    <select id="userInfo_gender_edit" name="userInfo.gender"  class="form-control">
		  ...
		  <div class="form-group">
		  	 ...
		  	 <div class="col-md-9">
			 	<select id="userInfo_schoolState_edit" name="userInfo.schoolState" class="form-control">
		  ...
		  <div class="form-group">
		  	 ...
		  	 <div class="col-md-9">
			    ...
			    <select id="userInfo_roleName_edit" name="userInfo.roleName" class="form-control">
