...
<%
    ...
    String schoolState = (String)request.getAttribute("schoolState"); //是否在校查询关键字
    String roleName = (String)request.getAttribute("roleName"); //用户身份查询关键字
%>
<!DOCTYPE html>
<html>
<head>
...
<jsp:include page="../header.jsp"></jsp:include>
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>UserInfo/<%=userInfo.getUser_name() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=userInfo.getUserPhoto()%>" /></a>
			     <div class="showFields">
			     	...
			     	<div class="field">
	            		是否在校:<%=userInfo.getSchoolState() %>
			     	</div>
			     	<div class="field">
	            		用户身份:<%=userInfo.getRoleName() %>
			     	</div>
			     	<div class="field">
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="userInfoQueryForm" id="userInfoQueryForm" action="<%=basePath %>UserInfo/frontlist" class="mar_t15" method="post">
			...
			<div class="form-group">
				<label for="schoolState">是否在校:</label>
				<input type="text" id="schoolState" name="schoolState" value="<%=schoolState %>" class="form-control" placeholder="请输入是否在校">
			</div>
			<div class="form-group">
				<label for="roleName">用户身份:</label>
				<input type="text" id="roleName" name="roleName" value="<%=roleName %>" class="form-control" placeholder="请输入用户身份">
			</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="userInfo_schoolState_edit" class="col-md-3 text-right">是否在校:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="userInfo_schoolState_edit" name="userInfo.schoolState" class="form-control" placeholder="请输入是否在校">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="userInfo_roleName_edit" class="col-md-3 text-right">用户身份:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="userInfo_roleName_edit" name="userInfo.roleName" class="form-control" placeholder="请输入用户身份">
			 </div>
		  </div>
		  <div class="form-group">
	...
	$.ajax({
		...
		success : function (userInfo, response, status) {
			if (userInfo) {
				...
				$("#userInfo_schoolState_edit").val(userInfo.schoolState);
				$("#userInfo_roleName_edit").val(userInfo.roleName);
