	...
	<div class="col-md-12 wow fadeInLeft">
		...
		<div class="row">
			<div class="col-md-10">
				  ...
				  <div class="form-group">
				  	 <label for="userInfo_schoolState" class="col-md-2 text-right">是否在校:</label>
				  	 <div class="col-md-8">
				  	 	<select id="userInfo_schoolState" name="userInfo.schoolState" class="form-control">
				  ...
				  <div class="form-group">
				  	 <label for="userInfo_roleName" class="col-md-2 text-right">用户身份:</label>
				  	 <div class="col-md-8">
				  	 	<select id="userInfo_roleName" name="userInfo.roleName" class="form-control">
