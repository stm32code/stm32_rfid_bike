...
<div id="userInfoAddDiv">
	<form id="userInfoAddForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="userInfo_schoolState" name="userInfo.schoolState" style="width:200px" />
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="userInfo_roleName" name="userInfo.roleName" style="width:200px" />
