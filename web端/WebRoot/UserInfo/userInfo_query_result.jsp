...
<div id="userInfo_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="userInfoQueryForm" method="post">
			...
			是否在校：<input type="text" class="textbox" id="schoolState" name="schoolState" style="width:110px" />
			用户身份：<input type="text" class="textbox" id="roleName" name="roleName" style="width:110px" />
...
<div id="userInfoEditDiv">
	<form id="userInfoEditForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			<span class="label">是否在校:</span>
			<span class="inputControl">
				<input class="textbox" type="text" id="userInfo_schoolState_edit" name="userInfo.schoolState" style="width:200px" />
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="userInfo_roleName_edit" name="userInfo.roleName" style="width:200px" />
