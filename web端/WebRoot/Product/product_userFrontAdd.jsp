...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-12 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>Product/frontlist">电动车管理</a></li>
  			<li class="active">添加电动车</li>
		</ul>
		<div class="row">
			<div class="col-md-10">
				  ...
				  <div class="form-group">
					 <label for="product_productNo" class="col-md-2 text-right">车牌号:</label>
					 <div class="col-md-8"> 
					 	<input type="text" id="product_productNo" name="product.productNo" class="form-control" placeholder="请输入车牌号">
					 </div>
				  </div> 
				  <div class="form-group">
				  	 <label for="product_productClassObj_classId" class="col-md-2 text-right">电动车类别:</label>
				  	 <div class="col-md-8">
				  ...
				  <div class="form-group">
				  	 <label for="product_productName" class="col-md-2 text-right">电动车名称:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="product_productName" name="product.productName" class="form-control" placeholder="请输入电动车名称">
					 </div>
				  </div>
				  <div class="form-group">
				  	 <label for="product_mainPhoto" class="col-md-2 text-right">电动车主图:</label>
				  	 <div class="col-md-8">
				  ...
				  <div class="form-group">
				  	 <label for="product_price" class="col-md-2 text-right">电动车价格:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="product_price" name="product.price" class="form-control" placeholder="请输入电动车价格">
					 </div>
				  </div>
				  <div class="form-group">
				  	 <label for="product_productDesc" class="col-md-2 text-right">电动车描述:</label>
				  	 <div class="col-md-8">
				  ...
				  <div class="form-group" style="display:none;">
				  	 <label for="product_userObj_user_name" class="col-md-2 text-right">所属用户:</label>
				  	 <div class="col-md-8">
				  ...
				  <div class="form-group" style="display:none;">
				  	 <label for="product_proState" class="col-md-2 text-right">电动车状态:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="product_proState" name="product.proState" value="待审核" class="form-control" placeholder="请输入电动车状态">
					 </div>
				  </div>
				  <div class="form-group" style="display:none;">
				  	 <label for="product_rfid" class="col-md-2 text-right">电动车RFID:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="product_rfid" name="product.rfid" value="--" class="form-control" placeholder="请输入电动车RFID">
					 </div>
				  </div>
		          <div class="form-group">
		             <span class="col-md-2""></span>
		             <span onclick="ajaxProductAdd();" class="btn btn-primary bottom5 top5">登记</span>
		          </div> 
...
<script>
//实例化编辑器
var product_productDesc_editor = UE.getEditor('product_productDesc'); //电动车描述编辑器
