		...
		<div class="row">
			<div class="col-md-10">
				  ...
				  <div class="form-group">
				  	 ...
				  	 <div class="col-md-8">
					    <input type="text" id="product_proState" name="product.proState" class="form-control" placeholder="请输入电动车状态">
					 </div>
				  </div>
				  <div class="form-group">
				  	 <label for="product_rfid" class="col-md-2 text-right">电动车RFID:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="product_rfid" name="product.rfid" class="form-control" placeholder="请输入电动车RFID">
					 </div>
				  </div>
		          <div class="form-group">
