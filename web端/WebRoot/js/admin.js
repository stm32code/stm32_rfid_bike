		       ...
		       text: "电动车进出管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "AccessInfo/accessInfo_add.jsp"
			    	   	},
			    		{
			    	   		text: "电动车进出管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "AccessInfo/accessInfo_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "挂失申请管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "LostApply/lostApply_add.jsp"
			    	   	},
			    		{
			    	   		text: "挂失申请管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "LostApply/lostApply_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "解冻申请管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "JieDong/jieDong_add.jsp"
			    	   	},
			    		{
			    	   		text: "解冻申请管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "JieDong/jieDong_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "补办申请管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Reissue/reissue_add.jsp"
			    	   	},
			    		{
			    	   		text: "补办申请管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Reissue/reissue_query_result.jsp"
			    	    }
			    	   ]
			},{
			       text: "系统管理",
