...
<jsp:include page="../header.jsp"></jsp:include>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>补办id</td><td>车牌号</td><td>补办用户</td><td>补办时间</td><td>补办原因</td><td>处理状态</td><td>rfid</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
 										...
 										<tr>
 											...
 											<td><%=reissue.getUserObj().getName() %></td>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="reissueQueryForm" id="reissueQueryForm" action="<%=basePath %>Reissue/frontlist" class="mar_t15" method="post">
