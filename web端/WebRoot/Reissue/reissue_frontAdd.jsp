				...
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="reissueAdd"> 
						  ...
						  <div class="form-group">
						  	 ...
						  	 <div class="col-md-8">
							    <input type="text" id="reissue_state" name="reissue.state" class="form-control" placeholder="请输入处理状态">
							 </div>
						  </div>
						  <div class="form-group">
				          ...
				          <div class="form-group">
				             ...
				             <span onclick="ajaxReissueAdd();" class="btn btn-primary bottom5 top5">添加</span>
				          </div>
						</form> 
